...
![(рис. 3. dmesg)](image/3.png){ #fig:015 width=70% height=70% }

![(рис. 4. Версия ядра линукс, частота процессора, модель процессора)](image/4.png){ #fig:016 width=70% height=70% }

![(рис. 5. Объем доступной оперативной памяти)](image/5.png){ #fig:017 width=70% height=70% }

![(рис. 6. Тип обнаруженного гипервизора)](image/6.png){ #fig:018 width=70% height=70% }

![(рис. 7. Тип файловой системы корневого раздела)](image/7.png){ #fig:019 width=70% height=70% }

![(рис. 8. Последовательность монтирования файловых систем)](image/8.png){ #fig:020 width=70% height=70% }
