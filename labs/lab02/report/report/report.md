...
author: "Выполнила: Гузева Ирина Николаевна"
...
![(рис. 3. log out)](image/3.png){ #fig:003 width=70% height=70% }

![(рис. 4. log in)](image/4.png){ #fig:004 width=70% height=70% }
...
![(рис. 5. pwd)](image/5.png){ #fig:005 width=70% height=70% }
...
![(рис. 6. cat /etc/passwd)](image/6.png){ #fig:006 width=70% height=70% }

9. Определите существующие в системе директории командой
ls -l /home/
Удалось ли вам получить список поддиректорий директории /home? Какие права установлены на директориях?

![(рис. 7. ls -l /home/)](image/7.png){ #fig:007 width=70% height=70% }
...
![(рис. 8. lsattr /home)](image/8.png){ #fig:008 width=70% height=70% }

11. Создайте в домашней директории поддиректорию dir1 командой
mkdir dir1
Определите командами ls -l и lsattr, какие права доступа и расширенные атрибуты были выставлены на директорию dir1.

![(рис. 9. mkdir dir1)](image/9.png){ #fig:009 width=70% height=70% }
...
![(рис. 10. chmod 000 dir1)](image/10.png){ #fig:010 width=70% height=70% }
...
![(рис. 11. "test" > /home/guest/dir1/file1)](image/11.png){ #fig:011 width=70% height=70% }
